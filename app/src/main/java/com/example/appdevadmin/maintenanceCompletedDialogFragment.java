...
public class maintenanceCompletedDialogFragment extends DialogFragment {

    public maintenanceCompletedDialogFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_maintenance_completed_dialog, container, false);
